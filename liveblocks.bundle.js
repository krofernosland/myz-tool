...
function createClient(options) {
  ...
  const throttleDelay = isLocalhost(baseUrl) && clientOptions.__DANGEROUSLY_disableThrottling ? 0 : getThrottle(clientOptions.throttle ?? DEFAULT_THROTTLE);
  ...
  function enterRoom(roomId, ...args) {
    ...
    const rawStorage = (typeof options2.initialStorage === "function" ? options2.initialStorage(roomId) : options2.initialStorage) ?? {};
    let initialStorage;
